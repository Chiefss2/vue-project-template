{
  mode: 'development',
  context: 'F:\\projects\\Vue\\vue-projects',
  ...
  output: {
    path: 'F:\\projects\\Vue\\vue-projects\\dist',
    filename: '[name].js',
    publicPath: '/',
    globalObject: 'this'
  },
  resolve: {
    alias: {
      '@': 'F:\\projects\\Vue\\vue-projects\\src',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: 'F:\\projects\\Vue\\vue-projects\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: 'ae911952'
            }
          },
        ...
        use: [
          /* config.module.rule('eslint').use('eslint-loader') */
          {
            ...
            options: {
              ...
              cache: true,
              cacheIdentifier: '1dd0b1ce',
              emitWarning: true,
              emitError: false,
              eslintPath: 'F:\\projects\\Vue\\vue-projects\\node_modules\\eslint\\lib\\api.js',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'F:\\projects\\Vue\\vue-projects\\public\\index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'F:\\projects\\Vue\\vue-projects\\public',
          to: 'F:\\projects\\Vue\\vue-projects\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
